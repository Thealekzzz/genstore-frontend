  ...
  const stepsData = [
    {
      ...
      childrens: (
        <>
          <p className={styles['concept__scheme-popup-text']}>
            Для расчета необходим файл с данными о трех поколениях предков
          </p>
          <a
            href="/assets/files/Пример файла для расчета.xlsx"
            download={true}
            className={styles['concept__scheme-popup-link']}
          >
    ...
    },
    {
      ...
      childrens: (
        <p className={styles['concept__scheme-popup-text']}>
          Создайте и настройте заявку на проведение расчета{' '}
          <Link className={styles['concept__scheme-popup-link']} to="/createrequest">
            на этой странице
          </Link>
        </p>
      ),
    ...
    },
    {
      ...
      childrens: (
        <p className={styles['concept__scheme-popup-text']}>
          После успешного выполнения расчета откроется возможность его оплаты
        </p>
      ),
    },
    {
      ...
      childrens: (
        <p className={styles['concept__scheme-popup-text']}>
          После оплаты на почту будет отправлен результирующий файл с расчитанными показателями
        </p>
      ),
    },
  ];
      ...
      <div className={styles['main']}>
          ...
          <div className={styles['lead__container']}>
            <div className={styles['lead__title-wrapper']}>
              ...
              <p className={styles['lead__subtitle']}>
                Прогнозирование племенной ценности крупного рогатого скота на основе математических моделей
              </p>
            </div>

            <div className={styles['lead__bottom']}>
              <h1 className={styles['lead__bottom-title']} ref={actionTitleRef}>
                {actionTexts[activeActionTextNumber]}
              </h1>
              <p className={styles['lead__bottom-subtitle']}>используя мощность облачных вычислений</p>
              <Link to="/createrequest" className={styles['button'] + ' ' + styles['lead__bottom-button']}>
                Отправить заявку
              </Link>
            </div>
          ...
          <ul className={styles['benefits__cards']}>
            <li className={styles['benefits__card']}>
              ...
              <p className={styles['benefits__card-text']}>
                Система быстро находит информацию о ваших быках и моментально производит расчет показателей у потомства
              </p>
            </li>
            ...
            <li className={styles['benefits__card']}>
              ...
              <p className={styles['benefits__card-text']}>
                Пока человек сделает один расчет племенной ценности — наша система успеет сделать десятки таких расчетов
              </p>
            </li>
            ...
            <li className={styles['benefits__card']}>
              ...
              <p className={styles['benefits__card-text']}>
                По результатам проведенного расчета мы даём персональные рекомендации по развитию стада
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="main__services block">
          ...
          <ul className="page__container main__services-list">
            <li className="main__services-item">
              <h3 className="main__services-item-title">
                <span className="highlighted">Прогнозирование</span>племенной ценности потомства
              </h3>
              <p className="main__services-item-text">
                Мы&nbsp;умеем прогнозировать племенную ценность потомства в&nbsp;стаде с&nbsp;использованием
                математических моделей
              </p>
            </li>
            <li className="main__services-item">
              <h3 className="main__services-item-title">
                <span className="highlighted">Аудит</span>генетики стада
              </h3>
              <p className="main__services-item-text">
                Мы&nbsp;можем выполнять поиск и&nbsp;ранжирование быков в&nbsp;стаде по&nbsp;племенной ценности
                актуальной геномной оценки
              </p>
            </li>
          </ul>

          <div className="page__container main__services-foooter">
            <ButtonAccent href="/createrequest" style={{ marginTop: 40 }}>
              Создать заявку
            </ButtonAccent>
          </div>
        </div>
        ...
        <div className={styles['main__team'] + ' ' + styles['section']}>
          <div className={styles['team__container']}>
            ...
            <p className={styles['section__subtitle'] + ' ' + styles['team__subtitle']}>
              Проект разработан специалистами из областей сельскохозяйственной генетики и разработки вычислительных
              облачных сервисов
            </p>
            ...
            <ul className={styles['team__members']}>
              <li className={styles['team__member']}>
                <img
                  src="https://sun9-1.userapi.com/impg/F6zxiX21uvKBE49MiLU3hfZN4AhS9BvvzCZF3A/6lx_ueqaP-k.jpg?size=960x1280&quality=96&sign=d2ca6e0438697afdfba74e30113b02b8&type=album"
                  className={styles['team__member-image']}
                  alt="Фото представителя команды"
                />
                <div>
              ...
              <li className={styles['team__member']}>
                <img
                  src="https://sun9-43.userapi.com/impg/hjHDCtiz252auBYaPuJOqIH7Jv5gH3viG_vpdw/_IfKIStIVes.jpg?size=960x1280&quality=95&sign=468aad0ec23325aeb0087122cb78c7c5&type=album"
                  className={styles['team__member-image']}
                  alt="Фото представителя команды"
                />
                <div>
