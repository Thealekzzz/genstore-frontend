...
const Calculator = () => {
  ...
  const promocodes = {
    SALE10: { sale: 0.1, description: '-10% на сумму расчета' },
    SALE20: { sale: 0.2, description: '-20% на сумму расчета' },
  };
    ...
    <div className="calculator">
      <div className="page__container">
        <div className="page__head ">
          ...
          <p className="page__text calculator__text">
            Здесь можно расчитать стоимость расчета с учетом количества данных и промокодов
          </p>
        </div>
      </div>
              ...
              <div className="calculator__promo-section-head">
                <label className="input__label">
                  <input
                    type="text"
                    id="input-promo"
                    className="input input_type_simple input_color_white calculator__promo-input"
                ...
                <button className="button" onClick={handlePromoCheck}>
                  Проверить
                </button>
              </div>
