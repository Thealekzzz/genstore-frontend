...
const CreateOrder = () => {
  ...
  const sale = Object.entries(appliedPromocodes).reduce((acc, [, { sale }]) => acc + sale / 100, 0);
        ...
        <Box {...styles.form} component="form">
          <Box {...styles.horizontalContainer}>
            ...
            <Button {...styles.fileButton}>
              ...
              <input hidden required type="file" name="file" onChange={handleFileChange} />
            </Button>
            {/* </Box> */}
          ...
          <Box {...styles.extraInfo}>
              ...
              <Box {...styles.typeContainer}>
                <Box
                  ...
                  sx={{
                    ...
                    backgroundColor: values.type === 'Прогнозирование' ? '#3580E8' : '#0001',
                    color: values.type === 'Прогнозирование' ? 'white' : '#0009',
                  }}
                >
                  <Typography
                    sx={{
                  ...
                  <Typography {...styles.typeText}>Вычисление показателей геномной оценки потомков</Typography>
                </Box>
                <Box
                  {...styles.typeOption}
                  ...
                  sx={{
                    ...styles.typeOption.sx,
                    backgroundColor: values.type === 'Аудит' ? '#3580E8' : '#0001',
                    color: values.type === 'Аудит' ? 'white' : '#0009',
                  }}
                >
                  <Typography
                    sx={{
                  ...
                  <Typography {...styles.typeText}>Исследование показателей геномной оценки стада</Typography>
                </Box>
              </Box>
            </Box>
            ...
            <Box {...styles.section}>
              <Box {...styles.horizontalSideContainer}>
                ...
                />
                <Button {...styles.promoButton} onClick={handlePromoButtonClick} disabled={isPromocodeFetching}>
                  Проверить
                </Button>
              </Box>
              ...
              <Box {...styles.section}>
                ...
                >
                  <Typography {...styles.typeText}>
                    Система нашла {rowsNumber} строк с данными в загруженном файле
                  </Typography>
          ...
          >
            ...
            <Button onClick={handleSubmitButtonClick} variant="contained" disabled={!isValid}>
              Отправить
            </Button>
          </Box>
        </Box>
      </Container>
      <Snackbar open={isErrorSnackOpen} autoHideDuration={4000} onClose={() => setIsErrorSnackOpen(false)}>
        <Alert severity="error" onClose={() => setIsErrorSnackOpen(false)}>
          {errorMessage}
        </Alert>
      </Snackbar>
      <Snackbar open={isInformationSnackOpen} autoHideDuration={4000} onClose={() => setIsInformationSnackOpen(false)}>
