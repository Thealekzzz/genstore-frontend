...
const Profile = ({ setIsAuthorized, userData }) => {
  const nameByStatus = {
    created: 'Создана',
    pending: 'В работе',
    ...
    <>
        ...
        {isAuthorized ? (
          <>
            <section className="profile-lead">
              ...
              <img
                src={`${SERVER_URL}:${SERVER_PORT}/images/${userData.photo || 'sample.jpg'}`}
                alt=""
                className="profile-lead__user-photo"
              />
      ...
      <Popup isOpen={isEditPopupOpen} setIsOpen={setIsEditPopupOpen} style={{ gap: 20, width: 600 }}>
        ...
        <Form className={styles['popup__form']} onSubmit={console.log}>
          <div className={styles['form__general']}>
            ...
            <div className={styles['input-field']}>
              <input
                ...
                autoComplete="nope"
              />
              <label htmlFor="surname" className={styles['input-field__label']}>
                Фамилия
              </label>
              <span className={styles['input-field__error-message']}></span>
            </div>
            ...
            <div className={styles['input-field']}>
              <input
                ...
                autoComplete="nope"
              />
              <label htmlFor="lastname" className={styles['input-field__label']}>
                Отчество
              </label>
              <span className={styles['input-field__error-message']}></span>
            </div>
          ...
          <div className={styles['form__additional']}></div>
        </Form>
      </Popup>
    </>
  );
