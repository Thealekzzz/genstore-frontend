...
const ButtonWithStatus = ({
  ...
  return (
    <div
      ...
      style={{
        flexDirection: statusOnTheLeft ? 'row-reverse' : 'row',
        alignSelf: statusOnTheLeft ? 'flex-end' : 'flex-start',
      }}
    >
      <ButtonAccent type={type} onClick={handleClick} ref={buttonRef} buttonDisabled={buttonDisabled}>
        {buttonText}
      </ButtonAccent>
