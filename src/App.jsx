      ...
      <TokenContext.Provider value={localStorage.getItem('token')}>
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/login" element={<Login setUserData={setUserData} setIsAuthorized={setIsAuthorized} />} />
            <Route path="/registration" element={<Registration />} />

            <Route path="/howitworks" element={<HowItWorks />} />
            <Route path="/calculator" element={<Calculator userData={userData} />} />

            <Route path="/createrequest" element={<ProtectedRoute element={CreateOrder} isLogged={isAuthorized} />} />
            <Route
              path="/search"
